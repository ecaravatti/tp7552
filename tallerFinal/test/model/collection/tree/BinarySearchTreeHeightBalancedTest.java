...
public class BinarySearchTreeHeightBalancedTest {// extends TestCase {
	...
	/*
	 * @Test public void testHeight() throws BSTKeyFoundException {
	 * treeAVL.insert(new Integer(5)); treeAVL.insert(new Integer(10));
	 * treeAVL.insert(new Integer(3)); treeAVL.insert(new Integer(8));
	 * treeAVL.insert(new Integer(12)); assertEquals(5,
	 * treeAVL.traversePreOrder().next().getData().intValue()); assertEquals(3,
	 * treeAVL.getHeight());
	 * 
	 * treeAVL.insert(new Integer(6)); assertEquals(3, treeAVL.getHeight());
	 * treeAVL.insert(new Integer(15)); //assertEquals(10,
	 * treeAVL.traversePreOrder().next().getData().intValue()); // Arbol
	 * completo assertEquals(3, treeAVL.getHeight()); assertEquals(7,
	 * treeAVL.getSize()); }
	 */
	...
	@Test
	public void testAVLDelete1() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
		treeAVL.insert(new Integer(5));
		assertEquals(1, treeAVL.getHeight());
	...
	@Test
	public void testAVLDelete2() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
		treeAVL.insert(new Integer(5));
		assertEquals(1, treeAVL.getHeight());
		treeAVL.insert(new Integer(3));
	...
	@Test
	public void testAVLDelete3() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
	...
	@Test
	public void testAVLDelete4() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
	...
	@Test
	public void testAVLDelete5() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
		// Borrado por rotacion doble
	...
	@Test
	public void testAVLDelete6() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
		// Borrado por rotacion doble
