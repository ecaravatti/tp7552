...
public class BinarySearchTreeWeightBalancedTest {
	...
	/*
	 * @Test public void testRotate() throws BSTKeyFoundException { tree = new
	 * BSTWeightBalanced<Integer>(1); tree.insert(new Integer(5));
	 * tree.insert(new Integer(10)); tree.insert(new Integer(3));
	 * tree.insert(new Integer(8)); tree.insert(new Integer(12));
	...
	@Test
	public void testDelete1() throws BSTKeyFoundException,
	...
	@Test
	public void testDelete2() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
	...
	@Test
	public void testDelete3() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
		tree.insert(new Integer(5));
		assertEquals(1, tree.getHeight());
		tree.insert(new Integer(3));
	...
	@Test
	public void testDelete5() throws BSTKeyFoundException,
			BSTKeyNotFoundException, BSTEmptyTreeException {
	...
	@Test
	public void testAVLDelete7() throws BSTKeyFoundException,
			BSTKeyNotFoundException {
		// Borrado por rotacion doble
