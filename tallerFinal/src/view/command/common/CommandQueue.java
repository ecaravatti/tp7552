...
public class CommandQueue implements Runnable {
  ...
  /**
   * @param delay retardo con que se ejecutan los comandos
   * @param defautlCommand tarea que se ejecuta por defecto (si no hay otras
   *        tareas).
   */
   ...
   * @param command nuevo comando a ser ejecutado
   */
   ...
   * @param commands comandos a ser ejecutados
   */
   ...
   * inmediatamente.
   * @param commands comandos a ser ejecutados inmediatamente.
   */
   ...
   * @param defaultCommand nuevo comando que se ejecutara por defecto
   */
   ...
   * @param w true si los comandos deben esperar, false en caso contrario.
   */
