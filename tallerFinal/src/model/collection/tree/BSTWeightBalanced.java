 ...
 * cuando para cada uno de sus nodos ocurre que el balance <tt>p(t)</tt> está
 * acotado por: <tt>[a, 1-a]</tt>, con <tt>a</tt> tal que
 * <tt>0 &le a &le 1/2</tt>.
 * 
 * <p>
 * El balance del nodo t, <tt>p(t)</tt>, se define como:
 * <p>
 * <code>p(t) = cant_nodos en t_izquierdo / cant_nodos en t</code>
 * 
 * <p>
 * Para esta implementacion, el parametro <tt>a</tt> está acotado entre:
 * <p>
 * <tt>2/11 &le a &le 1 - sqrt(2)/2</tt>.
 * 
 * <p>
 * Se cumple que la <u>altura total del arbol [h(n)]</u> con n nodos está
 * acotada por:
 * <p>
 * <code>log2(n+1) &le h(n) &le log2(n)/log2(1 - a)</code>
 * 
 * <p>
 ...
 */
public class BSTWeightBalanced<K extends Comparable<K>> extends
		BinarySearchTree<K> {
	...
	/**
	 * Realiza las rotaciones que sean necesarias en el nodo para balancearlo
	 * 
	 * @param node
	 *            nodo a balancear
