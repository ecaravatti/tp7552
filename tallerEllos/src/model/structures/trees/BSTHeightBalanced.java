 ...
 * cuando para cada uno de sus nodos ocurre que las <u>alturas</u>
 * de sus dos subarboles difieren a lo sumo en <tt>K</tt>
 * (parámetro entero no nulo).
 *
 * <p>Para el caso particular en que <tt>K</tt> vale 1, a este árbol se lo llama
 * Árbol AVL (por sus autores Adel'son-Vels'ki y Landis).
 *
 * <p>Gracias a este balanceo, se cumple que la <u>altura total del arbol [h(n)]</u>
...
public class BSTHeightBalanced<K extends Comparable<K>> extends BinarySearchTree<K> {
    ...
    /**
     * <a href="http://www.cmcrossroads.com/bradapp/ftp/src/libs/C++/AvlTrees.html">
     * Fuente para el ajuste de balance luego de una rotacion
     * </a>
     */
    @Override
