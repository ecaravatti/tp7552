...
import model.structures.trees.exceptions.*;
...
public abstract class BinarySearchTree<K extends Comparable<K>> extends BinarySearchTreeObservable<K> {
    ...
    public void clear() {
   	...
   	protected abstract BSTNode<K> insertNode(K data, BSTNode<K> node) throws BSTKeyFoundException;

    /**
     * Inserta un nodo con la data indicada
     * @param data la informacion que identifica al nodo
     * @throws model.structures.trees.exceptions.BSTKeyFoundException si ya existe la clave del nodo
     */
     ...
     * @param data la informacion que identifica al nodo
     * @param node subarbol donde buscar al nodo
     * @return el subarbol actualizado
     * @throws model.structures.trees.exceptions.BSTKeyNotFoundException
     */
    protected BSTNode<K> deleteNode(K data, BSTNode<K> node) throws BSTKeyNotFoundException {
        if (node == null) {
     ...
     * @param data la informacion que identifica al nodo
     * @throws model.structures.trees.exceptions.BSTKeyNotFoundException si no existe la clave del nodo
     */
     ...
     * @param node Subarbol a rotar
     * @param side Lado hacia donde rotar
     ...
     */
    protected abstract void adjustBalance(BSTNode<K> node, BSTNode<K> temp, int side);
    ...
    /**
     * Calcula la altura del arbol, es decir el camino más largo de la raíz
     * a cualquier hoja.
     * <p>Con dicha definición, un arbol nulo tiene altura 0 y un arbol con
     * un único nodo tiene altura 1.
    ...
    /**
     * Recorre el arbol en in-order (visita el subarbol izquierdo, luego
     * la raiz y finalmente el subarbol derecho).
     * @return iterador para recorrer el arbol
     */
    ...
    /**
     * Recorre el arbol en post-order (visita el subarbol izquierdo, luego
     * el subarbol derecho y finalmente la raiz).
     * @return iterador para recorrer el arbol
     */
