...
public class CreateAnimationCommand implements Command {
     ...
     */
    public CreateAnimationCommand(AnimatedPanel view, AnimationSteps animation, int number) {
        this.view = view;
        this.number = number;
     ...
     * @param number numero de animacion
     */
    public CreateAnimationCommand(AnimatedPanel view, Command command, int number) {
        this.view = view;
        this.number = number;
