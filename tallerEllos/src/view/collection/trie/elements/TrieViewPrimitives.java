...
public interface TrieViewPrimitives{
   ...
   * @param node nodo anadido al padre
   */
   ...
   * @param selected nodo dato seleccionado 
   * @param selectionColor color de seleccion
   */
  public void dataTrieNodeViewFound(DataTrieNodeView selected, Color selectionColor);

  /**
   * Debe invocarse cuando a un nodo se le elimina un hijo
   * @param parent nodo al que se le elimina un hijo
   ...
   * @param parent nodo al que se elimina un hermano
   * @param sibling nodo a eliminar
   */
