...
public class Arrow {
   ...
   * 
   * @param p1 punto en que inicia la flecha
   * @param p2 punto en que finaliza la flecha
   * @param fill true si debe pintarse la cabeza de la flecha
   */
  ...
  /**
   * Calcula el tamano de la cabeza de la flecha (es proporcional a la longitud
   * y al ancho del trazo)
