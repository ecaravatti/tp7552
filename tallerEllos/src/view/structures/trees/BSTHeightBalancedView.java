...
import view.commons.shapes.Segment;
import view.structures.trees.animations.BSTDobleRotationStartedAnimation;
import view.structures.trees.animations.BSTEndAnimation;
import view.structures.trees.animations.BSTNodeInsertedAnimation;
import view.structures.trees.animations.BSTNodeRotatedAnimation;
import view.structures.trees.animations.BSTNodeUpdatedAnimation;
import view.structures.trees.animations.BSTNodeVisitedAnimation;
import view.structures.trees.memento.BSTCaretaker;
...
import view.structures.trees.animations.BSTNodeRemovedAnimation;

/**
 *
 * @author Exe Curia
 */
public class BSTHeightBalancedView extends PanelAnimated implements BSTListener<Integer>, BSTPrimitives {
    ...
    public void dobleRotationStarted(BSTEvent<Integer> event) {
        this.addAnimationToQueue(new BSTDobleRotationStartedAnimation(this, event.getSide()));
    }
