...
import com.events.SuperPanelEvent;
 ...
 *
 *  @eventType com.events.SuperPanelEvent.MAXIMIZE
 */
[Event(name="maximize", type="com.events.SuperPanelEvent")]

/**
 *  Dispatched when the panel is minimized.
 *
 *  @eventType com.events.SuperPanelEvent.MINIMIZE
 */
[Event(name="minimize", type="com.events.SuperPanelEvent")]

/**
 *  Dispatched when the panel is restored from either a minimized or 
 *  maximized state.
 *
 *  @eventType com.events.SuperPanelEvent.RESTORE
 */
[Event(name="restore", type="com.events.SuperPanelEvent")]
 ...
 *
 *  @eventType com.events.SuperPanelEvent.DRAG_START
 */
[Event(name="dragStart", type="com.events.SuperPanelEvent")]

/**
 *  Dispatched while the panel is being dragged.
 *
 *  @eventType com.events.SuperPanelEvent.DRAG
 */
[Event(name="drag", type="com.events.SuperPanelEvent")]

/**
 *  Dispatched when the panel stops being dragged.
 *
 *  @eventType com.events.SuperPanelEvent.DRAG_END
 */
[Event(name="dragEnd", type="com.events.SuperPanelEvent")]

/**
 *  Dispatched when the resize handle is pressed.
 *
 *  @eventType com.events.SuperPanelEvent.RESIZE_START
 */
[Event(name="resizeStart", type="com.events.SuperPanelEvent")]

/**
 *  Dispatched when the mouse is released from the resize handle.
 *
 *  @eventType com.events.SuperPanelEvent.RESIZE_END
 */
[Event(name="resizeEnd", type="com.events.SuperPanelEvent")]
